...
<div class="ch-container">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 庫存管理系統 - 庫存統計</h2>
    ...
    <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
      ...
      <tr>
        <td align="center" bgcolor="#FFFFFF" height="27">設備類別</td>
        <td align="center" bgcolor="#FFFFFF">庫內數量</td>
      </tr>
      <?php 
      $sql="select type, count(*) from instock_table group by type";
      $val=mysql_query($sql,$conn);
      while($arr=mysql_fetch_row($val)){
      echo "<tr height='30'>";
      echo "<td align='center' bgcolor='#FFFFFF'>".$arr[0]."</td>";
      echo "<td align='center' bgcolor='#FFFFFF'>本類別數量共有：".$arr[1]."</td>";
      echo "</tr>";
      }
      ?>
    </table>

...
<div class="ch-container">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> 庫存管理系統 - 庫存查詢</h2>
          ...
          <tr>
            <td width="36%" align="center">
              <select name="seltype" id="seltype">
                <option value="name">設備名稱</option>
                <option value="uid">設備序號</option>
                <option value="property">財產標籤</option>
            ...
            <input type="submit" name="button" id="button" value="查詢" onClick="return q_cont();" />            </td>
          </tr>
        </table>
    </form></td>  
  </table>
    ...
    <tr>
        ...
        <tbody>
            <tr align="center">
                ...
                <td class="td_bg" width="8%">
                    <a href="update.php?id=<?php echo $rows[onlyid] ?>" class="trlink">修改</a>
                    &nbsp;&nbsp;
                    <a 
                        onclick=   
                            "if(window.confirm('確定要刪除該筆資料嗎?')) location.href='del.php?id=<?php echo $rows[onlyid] ?>';" 
                            class="trlink">刪除</a>
                </td>
            </tr>
        </tbody>
